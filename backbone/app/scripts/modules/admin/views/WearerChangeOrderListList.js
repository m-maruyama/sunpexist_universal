define([
	...
	'../Templates',
	'blockUI',
	'./WearerChangeOrderListItem'
], function(App) {
	'use strict';
	App.module('Admin.Views', function(Views, App, Backbone, Marionette, $, _){
		var order = 'asc';
		var sort_key = 'order_req_no';
		Views.WearerChangeOrderListList = Marionette.CompositeView.extend({
			template: App.Admin.Templates.wearerChangeOrderListList,
			emptyView: Backbone.Marionette.ItemView.extend({
                tagName: "tr",
				template: App.Admin.Templates.wearerEmpty,
			}),
			childView: Views.WearerChangeOrderListItem,
