define([
	...
	App.module('Admin.Views', function(Views, App, Backbone, Marionette, $, _){
		Views.WearerSizeChangeCondition = Marionette.LayoutView.extend({
			template: App.Admin.Templates.wearerSizeChangeCondition,
			behaviors: {
				"Alerts": {
			...
			onShow: function() {
				...
				// 前検索結果状態を表示
				if (window.sessionStorage.getItem("back_wearer_size_change_cond")) {
					this.triggerMethod('hideAlerts');
					var cond = window.sessionStorage.getItem("back_wearer_size_change_cond");
					window.sessionStorage.removeItem("back_wearer_size_change_cond");
