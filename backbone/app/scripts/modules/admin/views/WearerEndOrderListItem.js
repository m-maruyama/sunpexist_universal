define([
	'app',
	'../Templates',
	'./WearerEndOrderListItem',
	"entities/models/WearerEndOrderAbstract"
], function(App) {
	'use strict';
	App.module('Admin.Views', function(Views, App, Backbone, Marionette, $, _){
		Views.WearerEndOrderListItem = Marionette.ItemView.extend({
			template: App.Admin.Templates.wearerEndOrderListItem,
			tagName: "tr",
			ui: {
				"detailLink": "a.detail"
			},
