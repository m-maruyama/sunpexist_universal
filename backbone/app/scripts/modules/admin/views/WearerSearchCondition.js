define([
	...
	App.module('Admin.Views', function(Views, App, Backbone, Marionette, $, _){
		Views.WearerSearchCondition = Marionette.LayoutView.extend({
			template: App.Admin.Templates.wearerSearchCondition,
			behaviors: {
				"Alerts": {
			...
			onShow: function() {
				...
				// 前検索結果状態を表示
				if (window.sessionStorage.getItem("back_wearer_search_cond")) {
					this.triggerMethod('hideAlerts');
					var cond = window.sessionStorage.getItem("back_wearer_search_cond");
					window.sessionStorage.removeItem("back_wearer_search_cond");
