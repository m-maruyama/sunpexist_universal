define([
	...
	"entities/models/WearerChangeOrderAbstract"
], function(App) {
	'use strict';
	App.module('Admin.Views', function(Views, App, Backbone, Marionette, $, _){
		Views.WearerChangeOrderListItem = Marionette.ItemView.extend({
			template: App.Admin.Templates.wearerChangeOrderListItem,
			tagName: "tr",
			ui: {
				"detailLink": "a.detail"
			},
