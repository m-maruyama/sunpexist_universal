define([
	...
	App.module('Admin.Views', function(Views, App, Backbone, Marionette, $, _){
		var mode ='';
		var search_flg ='';
		Views.DeliveryCondition = Marionette.LayoutView.extend({
			template: App.Admin.Templates.deliveryCondition,
			regions: {
				"job_type": ".job_type"
			},
			ui: {
		...
		events: {
			...
			'click @ui.download': function(e){
				...
				var form = $('<form action="' + App.api.DE0020 + '" method="post"></form>');
