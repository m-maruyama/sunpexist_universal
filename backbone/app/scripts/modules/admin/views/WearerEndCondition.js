	...
	App.module('Admin.Views', function(Views, App, Backbone, Marionette, $, _){
		Views.WearerEndCondition = Marionette.LayoutView.extend({
			...
			onRender: function() {
				...
				// 前検索結果状態を表示
				if (window.sessionStorage.getItem("back_wearer_end_cond")) {
					this.triggerMethod('hideAlerts');
					var cond = window.sessionStorage.getItem("back_wearer_end_cond");
					window.sessionStorage.removeItem("back_wearer_end_cond");
