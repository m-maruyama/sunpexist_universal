define([
	...
	App.module('Admin.Views', function(Views, App, Backbone, Marionette, $, _){
		...
		Views.InquiryListList = Marionette.CompositeView.extend({
			template: App.Admin.Templates.inquiryListList,
			emptyView: Backbone.Marionette.ItemView.extend({
                tagName: "tr",
								template: App.Admin.Templates.inquiryEmpty,
      }),
			childView: Views.InquiryListItem,
			...
			fetch:function(inquiryListConditionModel){
				var cond = {
					"scr": '請求書データ照会',
					"page":this.options.pagerModel.getPageRequest(),
					"cond": inquiryListConditionModel.getReq()
				};
